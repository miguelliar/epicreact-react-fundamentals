...
Remember restructuring when reusing props! If the props name and values will be 
the same and there is no change needed, try with Destructuring!
...
In case you need managing specific attributes, try with the following: 
```jsx
function Box({className, style, ...otherProps}) { 
  // IT IS EXTREMELY IMPORTANT THAT THE PARAMS RECEIVE ONLY ONE OBJECT (props)
  return <div 
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=05%3A%20Styling&em=uo270927%40uniovi.es).
